...
2. Inicialização do Cliente S3<br>
...
3. Configuração do Bucket e do Arquivo<br>
...
4. Realização do Upload do Arquivo<br>
...
1. Tratamento de Dados Ausentes<br>
...
3. Seleção de Colunas Relevantes<br>
...
1. Padronização dos Dados na Coluna "paisorigem"<br>
...
2. Contagem de Ocorrências por País<br>
...
1. Preenchimento de Valores Nulos<br>
...
3. Criação de uma Nova Coluna<br>
...
1. Definição da Função processar_periodo<br>
...
1. Definição da Função extrair_ano_inicio<br>
...
2. Aplicação da Função ao DataFrame<br>
...
3. Limpeza dos Nomes das Colunas<br>
...
4. Remoção de Colunas Não Nomeadas<br>
...
1. Verificação da Coluna nomediscente<br>
...
2. Preenchimento de Valores Nulos<br>
